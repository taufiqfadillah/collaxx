...
const services_data = [
  ...
  // home two
  {
    ...
    text_1:'We develop digital marketing strategies and execute tactics such as SEO, PPC, social media, email marketing, and so on. The service also includes monitoring campaign results and providing recommendations to improve campaign effectiveness going forward. With this service, customers can increase their brand visibility and sales online.',
    home_2:true,
    service_p_3:true,
  },
  {
    ...
    text_1:'A service that helps customers to promote their brand or product through various social media platforms such as Facebook, Instagram, Twitter, and so on. will assist customers in developing the right social media marketing strategy for their brand or product, such as choosing the right social media platform, creating engaging content, and building a relevant audience.',
    home_2:true,
    service_p_3:true,
  },
  {
    ...
    text_1:'A service that helps customers to promote their brand or product through search engines such as Google, Bing, Yahoo, and so on. We will assist customers in developing the right search marketing strategy for their brand or product, such as selecting relevant keywords, creating attractive ads, and optimizing landing pages.',
    home_2:true,
    service_p_3:true,
  },
  // home three
